...
public class UIProceedToCheckout {
    WebDriver driver;
    ...
    public void testCheckout() {
        ...
        By proceedToCheckoutButton = By.xpath("//span[contains(text(), 'Sepeti Onayla')]");
        elementActions.click(proceedToCheckoutButton);

        String currentUrl = driver.getCurrentUrl();
        Assert.assertTrue(currentUrl.contains("/sepetim/odeme"), "Checkout page did not open.");
